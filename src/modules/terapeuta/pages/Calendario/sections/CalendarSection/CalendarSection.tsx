      ...
      <section className="flex flex-col items-start gap-6 py-6 relative flex-1 self-stretch grow bg-white w-full">
        <header className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto] bg-transparent px-6">
          ...
          <div className="inline-flex items-center gap-3 self-stretch">
            <Button 
              className="bg-primary-500 hover:bg-primary-600 text-white rounded-full px-6 py-2 text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-2"
              onClick={handleSchedulePatient}
            >
              Agendar paciente
              <PlusIcon className="w-4 h-4" />
            </Button>
            <Button className="bg-white hover:bg-primary-50 text-primary-500 border border-primary-200 hover:border-primary-300 rounded-full px-6 py-2 text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-2">
              Agregar paciente
              <PlusIcon className="w-4 h-4" />
            </Button>
          </div>
