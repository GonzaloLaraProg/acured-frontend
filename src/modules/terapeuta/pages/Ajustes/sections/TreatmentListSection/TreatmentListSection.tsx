...
export const TreatmentListSection = ({ onTabChange }: TreatmentListSectionProps): JSX.Element => {
  ...
  // Filter labels
  const filterLabels = ["Label", "Label", "Label", "Label"];

  // Table data - Original data as requested
  const tableData = [
    {
  ...
  const handleSaveTreatment = () => {
    // Aquí puedes agregar la lógica para guardar el tratamiento
              ...
              <div className="flex items-start justify-end gap-6 relative self-stretch w-full flex-1">
                <div className="gap-4 flex-1 grow flex flex-col items-start h-full">
                  ...
                  <div className="flex items-center gap-2 relative self-stretch w-full">
                    <Badge className="bg-primary-600 text-white rounded-[25px] px-3 py-1">
                    ...
                    {filterLabels.map((label, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="bg-white rounded-[25px] px-3 py-1 border-gray-200 text-primary-600"
                      >
                    ...
                    <div className="flex items-center justify-end gap-3 relative flex-1 grow">
                      <div className="flex w-80 items-center gap-2 px-4 py-2 relative rounded border border-solid border-gray-300 bg-white">
                        <SearchIcon className="w-5 h-5 text-shadow-300" />
                        <Input
                          className="border-0 p-0 h-auto shadow-none text-body-md text-shadow-300 bg-transparent"
                          placeholder="Buscar..."
                        />
                      </div>
                    </div>
